...
export const requestLogin = async (
  ...
  let query = (query = query.replace("{{args.email}}", args.email));
  query = query.replace("{{args.password}}", args.password);
  Query.replace("{{fields}}", fields);
  login;
...
export const requestCreateProduct = async (
  ...
  let query = (query = query.replace("{{args.data}}", args.data));
  Query.replace("{{fields}}", fields);
  createProduct;
...
export const requestUpdateProduct = async (
  ...
  let query = (query = query.replace("{{args.id}}", args.id));
...
export const requestCreateNews = async (
  ...
  let query = (query = query.replace("{{args.productId}}", args.productId));
  query = query.replace("{{args.data}}", args.data);
  Query.replace("{{fields}}", fields);
  createNews;
