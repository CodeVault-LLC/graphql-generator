...
import { requestMe, requestUser, requestProducts, requestProduct, requestNewsLatestPublished, requestNewsByProduct, requestNewsStatisticsByProductId, requestNewsById, requestLogin, requestCreateProduct, requestUpdateProduct, requestCreateNews, requestUpdateNews } from './resources';export const useMe = (selection: Partial<Record<keyof User, boolean>>, ) => {
...
export const useCreateProduct = (selection: Partial<Record<keyof Product, boolean>>) => {
  return useMutation<Product, unknown, { data: ProductCreateInput | null }>({
...
export const useUpdateProduct = (selection: Partial<Record<keyof Product, boolean>>) => {
  return useMutation<Product, unknown, { id: string, data: ProductUpdateInput | null }>({
